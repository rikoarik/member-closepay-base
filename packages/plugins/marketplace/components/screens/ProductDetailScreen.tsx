...
import { ArrowLeft2, Heart, ShoppingCart, Star1, Shop, Add, Minus, Bag2 } from 'iconsax-react-nativejs';
import {
    scale,
...
export const ProductDetailScreen: React.FC = () => {
    ...
    const startAddToCartAnimation = useCallback((callback: () => void) => {
        setIsAnimating(true);
                ...
                <View style={styles.imageContainer}>
                    <Image
                        source={{
                            uri: imageError
                                ...
                                : product.imageUrl || 'https://via.placeholder.com/400x400/CCCCCC/FFFFFF?text=Product',
                        }}
                    ...
                    {discountPercentage && (
                        <View style={[styles.discountBadge, { backgroundColor: colors.error }]}>
                            <Text style={styles.discountText}>{discountPercentage}% {t('marketplace.off')}</Text>
                        </View>
                    )}
                </View>
                ...
                <View style={[styles.infoContainer, { paddingHorizontal: horizontalPadding }]}>
                        ...
                        {product.sold !== undefined && (
                            <Text style={[styles.soldText, { color: colors.textSecondary }]}>
                                {product.sold > 1000
                                    ...
                                    : product.sold} {t('marketplace.sold')}
                            </Text>
                        )}
                    </View>
                    ...
                    <View style={styles.descriptionSection}>
                        ...
                        <Text style={[styles.descriptionText, { color: colors.textSecondary }]}>
                            {product.description || 'Produk berkualitas tinggi dengan harga terjangkau. Cocok untuk kebutuhan sehari-hari Anda.'}
                        </Text>
                    </View>
            ...
            >
                ...
                <View style={styles.actionButtonsContainer}>
                    ...
                    <TouchableOpacity
                        ...
                        style={[styles.actionButton, styles.cartButtonOutline, { borderColor: colors.primary }]}
                        onPress={handleAddToCart}
                        activeOpacity={0.8}
                    >
                        <ShoppingCart size={scale(20)} color={colors.primary} variant="Bold" />
                    </TouchableOpacity>
