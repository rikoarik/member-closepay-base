                ...
                <View style={styles.profileContent}>
                    <View style={styles.logoAndInfo}>
                        ...
                        <View style={styles.infoColumn}>
                            ...
                            {store.openingHours && (
                                <Text style={[styles.metaText, { color: colors.textSecondary, marginTop: scale(4) }]}>
                    ...
                    <View style={styles.actionButtons}>
                        <TouchableOpacity
                            ...
                            onPress={handleChat}
                        >
                            <Text style={[styles.chatButtonText, { color: colors.text }]}>{t('marketplace.chatWhatsApp')}</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            ...
            >
                ...
                <Text style={[styles.navTitle, { color: colors.text }]}>{t('marketplace.storeDetail')}</Text>
            </View>
