...
export const FnBCartDetailSheet: React.FC<FnBCartDetailSheetProps> = ({
    ...
    const handleIncrement = useCallback((cartId: string, currentQty: number) => {
        onUpdateQuantity(cartId, currentQty + 1);
    }, [onUpdateQuantity]);

    const handleDecrement = useCallback((cartId: string, currentQty: number) => {
        if (currentQty <= 1) {
            onRemoveItem(cartId);
        } else {
            onUpdateQuantity(cartId, currentQty - 1);
                ...
                <View style={styles.itemInfo}>
                    ...
                    <View style={styles.priceRow}>
                        ...
                        >
                            ...
                            <Text style={[styles.editButtonText, { color: colors.primary }]}>Ubah</Text>
                        </TouchableOpacity>
                    </View>
                </View>
